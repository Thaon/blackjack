...
public:
	Deck() : m_cards(51)
	{
		...
		m_cards[10] = Card("Nine of Spades", 11);
		m_cards[11] = Card("Queen of Spades", 11);
		m_cards[12] = Card("King of Spades", 11);
		...
		m_cards[1] = Card("Five of hearts", 5);
		m_cards[17] = Card("Six of hearts", 6);
		m_cards[18] = Card("Seven of hearts", 7);
		m_cards[19] = Card("Eight of hearts", 8);
		m_cards[20] = Card("Nine of hearts", 9);
		m_cards[21] = Card("Ten of hearts", 10);
		m_cards[22] = Card("Nine of hearts", 11);
		m_cards[23] = Card("Queen of hearts", 11);
		m_cards[24] = Card("King of hearts", 11);

		m_cards[25] = Card("Ace of clubs", 1, 11);
		m_cards[26] = Card("Two of clubs", 2);
		m_cards[27] = Card("Three of clubs", 3);
		m_cards[28] = Card("Four of clubs", 4);
		m_cards[29] = Card("Five of clubs", 5);
		m_cards[30] = Card("Six of clubs", 6);
		m_cards[31] = Card("Seven of clubs", 7);
		m_cards[32] = Card("Eight of clubs", 8);
		m_cards[33] = Card("Nine of clubs", 9);
		m_cards[34] = Card("Ten of clubs", 10);
		m_cards[35] = Card("Nine of clubs", 11);
		m_cards[36] = Card("Queen of clubs", 11);
		m_cards[37] = Card("King of clubs", 11);

		m_cards[38] = Card("Ace of diamonds", 1, 11);
		m_cards[39] = Card("Two of diamonds", 2);
		m_cards[40] = Card("Three of diamonds", 3);
		m_cards[41] = Card("Four of diamonds", 4);
		m_cards[42] = Card("Five of diamonds", 5);
		m_cards[43] = Card("Six of diamonds", 6);
		m_cards[44] = Card("Seven of diamonds", 7);
		m_cards[45] = Card("Eight of diamonds", 8);
		m_cards[46] = Card("Nine of diamonds", 9);
		m_cards[47] = Card("Ten of diamonds", 10);
		m_cards[48] = Card("Nine of diamonds", 11);
		m_cards[49] = Card("Queen of diamonds", 11);
		m_cards[50] = Card("King of diamonds", 11);
	}
